...
parser.add_argument('--minClipped', default=4, dest='minClipped', type=int, help='Minimum number of clipped reads supporting the alternative allele. Default: 4' )
parser.add_argument('--minREF', default=4, dest='minREF', type=int, help='Minimum number of reads supporting the reference allele. Default: 4' )
