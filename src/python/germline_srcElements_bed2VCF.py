...
for line in inputBED:
    ...
    if not line.startswith("#"):
        ...
        QUAL = '.'    
        FILTER = '.' 
        INFO	 = 'SVTYPE=<MEI>;' + 'CLASS=' + category + ';TYPE=TD0;BKPB=' + str(bkpB) + ';CIPOS=0;STRAND=' + orientation + ';TSLEN=' + TSDLen + ";TSSEQ=" + TSDSeq
        FORMAT = 'RCP:RCN' 
        GT = '.:.'
...
outFilePath = outDir + '/germline_source_elements.vcf'
